...
namespace MonoGameWorld.Drawables.Plane
{
    public class DrawablePlane
    {
        ...
        public DrawablePlane(GraphicsDeviceManager graphics, Texture2D planeTexture, int verticesWidth, int verticesHeight, float widthStep, float heightStep)
        {
            ...
            indexBuffer = new IndexBuffer(graphics.GraphicsDevice, typeof(int), Plane.Indices.Count, BufferUsage.None);
            indexBuffer.SetData<int>(Plane.Indices.ToArray());
        }
        ...
        public void Draw(Matrix view, Matrix projection)
        {
            ...
            {
                pass.Apply();
                graphics.GraphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, Plane.Indices.Count / 3);
            }
        }
    }
}
